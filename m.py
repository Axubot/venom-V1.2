...
bot = telebot.TeleBot('7203780377:AAEAM1L8Jr44urO_j0NfZ9Nyi7iehr_Tn7g')
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- 8114374152 🙇."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ sabo gand mare ga kya ʙᴜy:- 8114374152🙇."
    bot.reply_to(message, response)
...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ edhar louda milega ʙᴜʏ:- 8114374152❄."
    bot.reply_to(message, response)
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ke chud milega  buy :-8114374152❄."
        bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- 811437415")
